...
function insert_to_cart(name, description, src, price){
...
<template>
    <div class="card">
            ...
            <div class="card-title">Your cart<span class="card-title-amount">${{total}}</span></div>
            <div class="card-body">
                <!---->
                <div class="cart-items">
                  <!-- <CartItem name="Nike Epic React Flyknit 2" price="89.97" quantity="3" src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/1315882/epic-react-flyknit-2-mens-running-shoe-2S0Cn1-removebg-preview.png"/>
                  <CartItem name="Nike Epic React Flyknit 2" price="89.97" quantity="3" src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/1315882/epic-react-flyknit-2-mens-running-shoe-2S0Cn1-removebg-preview.png"/>
                  <CartItem name="Nike Epic React Flyknit 2" price="89.97" quantity="3" src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/1315882/epic-react-flyknit-2-mens-running-shoe-2S0Cn1-removebg-preview.png"/>
                  <CartItem name="Nike Epic React Flyknit 2" price="89.97" quantity="3" src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/1315882/epic-react-flyknit-2-mens-running-shoe-2S0Cn1-removebg-preview.png"/>
                  <CartItem name="Nike Epic React Flyknit 2" price="89.97" quantity="3" src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/1315882/epic-react-flyknit-2-mens-running-shoe-2S0Cn1-removebg-preview.png"/> -->
                    <CartItem v-for="item in items" :key="item.id" :name="item.name" :src="item.image" :price="item.price" :quantity="item.quantity" :color="item.color"/>
                </div>
            </div>
        </div>
</template>
